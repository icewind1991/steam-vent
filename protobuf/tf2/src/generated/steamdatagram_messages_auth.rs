...
pub struct CMsgSteamDatagramRelayAuthTicket {
    ...
    pub extra_fields: ::std::vec::Vec<super::steamdatagram_auth_messages::cmsg_steam_datagram_relay_auth_ticket::ExtraField>,
...
pub struct CMsgSteamDatagramSignedRelayAuthTicket {
    ...
    pub certs: ::std::vec::Vec<super::steamdatagram_auth_messages::CMsgSteamDatagramCertificateSigned>,
    // special fields
