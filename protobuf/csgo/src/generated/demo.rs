...
pub struct CDemoFileHeader {
    ...
    // @@protoc_insertion_point(field:CDemoFileHeader.server_start_tick)
    pub server_start_tick: ::std::option::Option<i32>,
    // special fields
...
impl<'a> ::std::default::Default for &'a CDemoFileHeader {
    fn default() -> &'a CDemoFileHeader {
        <CDemoFileHeader as ::steam_vent_proto_common::protobuf::Message>::default_instance()
    }
}
...
impl CDemoFileHeader {
    ...
    pub fn server_start_tick(&self) -> i32 {
        self.server_start_tick.unwrap_or(0)
    }

    pub fn clear_server_start_tick(&mut self) {
        self.server_start_tick = ::std::option::Option::None;
    }

    pub fn has_server_start_tick(&self) -> bool {
        self.server_start_tick.is_some()
    }

    // Param is passed by value, moved
    pub fn set_server_start_tick(&mut self, v: i32) {
        self.server_start_tick = ::std::option::Option::Some(v);
    }
}

impl ::steam_vent_proto_common::protobuf::Message for CDemoFileHeader {
    ...
    fn merge_from(&mut self, is: &mut ::steam_vent_proto_common::protobuf::CodedInputStream<'_>) -> ::steam_vent_proto_common::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                120 => {
                    self.server_start_tick = ::std::option::Option::Some(is.read_int32()?);
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let Some(v) = self.server_start_tick {
    ...
    fn default_instance() -> &'static CDemoFileHeader {
        static instance: CDemoFileHeader = CDemoFileHeader {
            ...
            server_start_tick: ::std::option::Option::None,
...
pub struct CGameInfo {
    ...
    pub dota: ::steam_vent_proto_common::protobuf::MessageField<cgame_info::CDotaGameInfo>,
    // @@protoc_insertion_point(field:CGameInfo.cs)
    pub cs: ::steam_vent_proto_common::protobuf::MessageField<cgame_info::CCSGameInfo>,
    // special fields
...
impl<'a> ::std::default::Default for &'a CGameInfo {
    fn default() -> &'a CGameInfo {
        <CGameInfo as ::steam_vent_proto_common::protobuf::Message>::default_instance()
    }
}
...
impl ::steam_vent_proto_common::protobuf::Message for CGameInfo {
    ...
    fn merge_from(&mut self, is: &mut ::steam_vent_proto_common::protobuf::CodedInputStream<'_>) -> ::steam_vent_proto_common::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                34 => {
                    ::steam_vent_proto_common::protobuf::rt::read_singular_message_into_field(is, &mut self.dota)?;
                },
                42 => {
                    ::steam_vent_proto_common::protobuf::rt::read_singular_message_into_field(is, &mut self.cs)?;
                },
                tag => {
                    ::steam_vent_proto_common::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn default_instance() -> &'static CGameInfo {
        static instance: CGameInfo = CGameInfo {
            dota: ::steam_vent_proto_common::protobuf::MessageField::none(),
            cs: ::steam_vent_proto_common::protobuf::MessageField::none(),
            special_fields: ::steam_vent_proto_common::protobuf::SpecialFields::new(),
        };
        &instance
    }
...
pub mod cgame_info {
    ...
    impl<'a> ::std::default::Default for &'a CDotaGameInfo {
        fn default() -> &'a CDotaGameInfo {
            <CDotaGameInfo as ::steam_vent_proto_common::protobuf::Message>::default_instance()
        }
    }
    ...
    impl ::steam_vent_proto_common::protobuf::Message for CDotaGameInfo {
    ...
    pub mod cdota_game_info {
        ...
        impl<'a> ::std::default::Default for &'a CPlayerInfo {
            fn default() -> &'a CPlayerInfo {
                <CPlayerInfo as ::steam_vent_proto_common::protobuf::Message>::default_instance()
            }
        }
        ...
        impl ::steam_vent_proto_common::protobuf::Message for CPlayerInfo {
        ...
        impl<'a> ::std::default::Default for &'a CHeroSelectEvent {
            fn default() -> &'a CHeroSelectEvent {
                <CHeroSelectEvent as ::steam_vent_proto_common::protobuf::Message>::default_instance()
            }
        }
        ...
        impl ::steam_vent_proto_common::protobuf::Message for CHeroSelectEvent {
    ...
    impl<'a> ::std::default::Default for &'a CCSGameInfo {
        fn default() -> &'a CCSGameInfo {
            <CCSGameInfo as ::steam_vent_proto_common::protobuf::Message>::default_instance()
        }
    }
    ...
    impl ::steam_vent_proto_common::protobuf::Message for CCSGameInfo {
...
pub struct CDemoFileInfo {
    ...
    pub game_info: ::steam_vent_proto_common::protobuf::MessageField<CGameInfo>,
    // special fields
...
impl<'a> ::std::default::Default for &'a CDemoFileInfo {
    fn default() -> &'a CDemoFileInfo {
        <CDemoFileInfo as ::steam_vent_proto_common::protobuf::Message>::default_instance()
    }
}
...
impl ::steam_vent_proto_common::protobuf::Message for CDemoFileInfo {
    ...
    fn merge_from(&mut self, is: &mut ::steam_vent_proto_common::protobuf::CodedInputStream<'_>) -> ::steam_vent_proto_common::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                34 => {
                    ::steam_vent_proto_common::protobuf::rt::read_singular_message_into_field(is, &mut self.game_info)?;
                },
                tag => {
                    ::steam_vent_proto_common::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn default_instance() -> &'static CDemoFileInfo {
        static instance: CDemoFileInfo = CDemoFileInfo {
            ...
            game_info: ::steam_vent_proto_common::protobuf::MessageField::none(),
            special_fields: ::steam_vent_proto_common::protobuf::SpecialFields::new(),
        };
        &instance
    }
...
impl<'a> ::std::default::Default for &'a CDemoPacket {
    fn default() -> &'a CDemoPacket {
        <CDemoPacket as ::steam_vent_proto_common::protobuf::Message>::default_instance()
    }
}
...
impl ::steam_vent_proto_common::protobuf::Message for CDemoPacket {
...
pub struct CDemoFullPacket {
    ...
    pub string_table: ::steam_vent_proto_common::protobuf::MessageField<CDemoStringTables>,
    // @@protoc_insertion_point(field:CDemoFullPacket.packet)
    pub packet: ::steam_vent_proto_common::protobuf::MessageField<CDemoPacket>,
    // special fields
...
impl<'a> ::std::default::Default for &'a CDemoFullPacket {
    fn default() -> &'a CDemoFullPacket {
        <CDemoFullPacket as ::steam_vent_proto_common::protobuf::Message>::default_instance()
    }
}
...
impl ::steam_vent_proto_common::protobuf::Message for CDemoFullPacket {
    ...
    fn merge_from(&mut self, is: &mut ::steam_vent_proto_common::protobuf::CodedInputStream<'_>) -> ::steam_vent_proto_common::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                10 => {
                    ::steam_vent_proto_common::protobuf::rt::read_singular_message_into_field(is, &mut self.string_table)?;
                },
                18 => {
                    ::steam_vent_proto_common::protobuf::rt::read_singular_message_into_field(is, &mut self.packet)?;
                },
                tag => {
                    ::steam_vent_proto_common::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn default_instance() -> &'static CDemoFullPacket {
        static instance: CDemoFullPacket = CDemoFullPacket {
            string_table: ::steam_vent_proto_common::protobuf::MessageField::none(),
            packet: ::steam_vent_proto_common::protobuf::MessageField::none(),
            special_fields: ::steam_vent_proto_common::protobuf::SpecialFields::new(),
        };
        &instance
    }
...
impl<'a> ::std::default::Default for &'a CDemoSaveGame {
    fn default() -> &'a CDemoSaveGame {
        <CDemoSaveGame as ::steam_vent_proto_common::protobuf::Message>::default_instance()
    }
}
...
impl ::steam_vent_proto_common::protobuf::Message for CDemoSaveGame {
...
impl<'a> ::std::default::Default for &'a CDemoSyncTick {
    fn default() -> &'a CDemoSyncTick {
        <CDemoSyncTick as ::steam_vent_proto_common::protobuf::Message>::default_instance()
    }
}
...
impl ::steam_vent_proto_common::protobuf::Message for CDemoSyncTick {
...
impl<'a> ::std::default::Default for &'a CDemoConsoleCmd {
    fn default() -> &'a CDemoConsoleCmd {
        <CDemoConsoleCmd as ::steam_vent_proto_common::protobuf::Message>::default_instance()
    }
}
...
impl ::steam_vent_proto_common::protobuf::Message for CDemoConsoleCmd {
...
impl<'a> ::std::default::Default for &'a CDemoSendTables {
    fn default() -> &'a CDemoSendTables {
        <CDemoSendTables as ::steam_vent_proto_common::protobuf::Message>::default_instance()
    }
}
...
impl ::steam_vent_proto_common::protobuf::Message for CDemoSendTables {
...
impl<'a> ::std::default::Default for &'a CDemoClassInfo {
    fn default() -> &'a CDemoClassInfo {
        <CDemoClassInfo as ::steam_vent_proto_common::protobuf::Message>::default_instance()
    }
}
...
impl ::steam_vent_proto_common::protobuf::Message for CDemoClassInfo {
...
impl<'a> ::std::default::Default for &'a CDemoCustomData {
    fn default() -> &'a CDemoCustomData {
        <CDemoCustomData as ::steam_vent_proto_common::protobuf::Message>::default_instance()
    }
}
...
impl ::steam_vent_proto_common::protobuf::Message for CDemoCustomData {
...
impl<'a> ::std::default::Default for &'a CDemoCustomDataCallbacks {
    fn default() -> &'a CDemoCustomDataCallbacks {
        <CDemoCustomDataCallbacks as ::steam_vent_proto_common::protobuf::Message>::default_instance()
    }
}
...
impl ::steam_vent_proto_common::protobuf::Message for CDemoCustomDataCallbacks {
...
// @@protoc_insertion_point(message:CDemoAnimationHeader)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct CDemoAnimationHeader {
    // message fields
    // @@protoc_insertion_point(field:CDemoAnimationHeader.entity_id)
    pub entity_id: ::std::option::Option<i32>,
    // @@protoc_insertion_point(field:CDemoAnimationHeader.tick)
    pub tick: ::std::option::Option<i32>,
    // @@protoc_insertion_point(field:CDemoAnimationHeader.data)
    pub data: ::std::option::Option<::std::vec::Vec<u8>>,
    // special fields
    // @@protoc_insertion_point(special_field:CDemoAnimationHeader.special_fields)
    pub special_fields: ::steam_vent_proto_common::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a CDemoAnimationHeader {
    fn default() -> &'a CDemoAnimationHeader {
        <CDemoAnimationHeader as ::steam_vent_proto_common::protobuf::Message>::default_instance()
    }
}

impl CDemoAnimationHeader {
    pub fn new() -> CDemoAnimationHeader {
        ::std::default::Default::default()
    }
...
impl ::steam_vent_proto_common::protobuf::Message for CDemoAnimationHeader {
    const NAME: &'static str = "CDemoAnimationHeader";
    ...
    fn new() -> CDemoAnimationHeader {
        CDemoAnimationHeader::new()
    }
    ...
    fn default_instance() -> &'static CDemoAnimationHeader {
        static instance: CDemoAnimationHeader = CDemoAnimationHeader {
...
impl<'a> ::std::default::Default for &'a CDemoAnimationData {
    fn default() -> &'a CDemoAnimationData {
        <CDemoAnimationData as ::steam_vent_proto_common::protobuf::Message>::default_instance()
    }
}
...
impl ::steam_vent_proto_common::protobuf::Message for CDemoAnimationData {
...
impl<'a> ::std::default::Default for &'a CDemoStringTables {
    fn default() -> &'a CDemoStringTables {
        <CDemoStringTables as ::steam_vent_proto_common::protobuf::Message>::default_instance()
    }
}
...
impl ::steam_vent_proto_common::protobuf::Message for CDemoStringTables {
...
pub mod cdemo_string_tables {
    ...
    impl<'a> ::std::default::Default for &'a Items_t {
        fn default() -> &'a Items_t {
            <Items_t as ::steam_vent_proto_common::protobuf::Message>::default_instance()
        }
    }
    ...
    impl ::steam_vent_proto_common::protobuf::Message for Items_t {
    ...
    impl<'a> ::std::default::Default for &'a Table_t {
        fn default() -> &'a Table_t {
            <Table_t as ::steam_vent_proto_common::protobuf::Message>::default_instance()
        }
    }
    ...
    impl ::steam_vent_proto_common::protobuf::Message for Table_t {
...
impl<'a> ::std::default::Default for &'a CDemoStop {
    fn default() -> &'a CDemoStop {
        <CDemoStop as ::steam_vent_proto_common::protobuf::Message>::default_instance()
    }
}
...
impl ::steam_vent_proto_common::protobuf::Message for CDemoStop {
...
impl<'a> ::std::default::Default for &'a CDemoUserCmd {
    fn default() -> &'a CDemoUserCmd {
        <CDemoUserCmd as ::steam_vent_proto_common::protobuf::Message>::default_instance()
    }
}
...
impl ::steam_vent_proto_common::protobuf::Message for CDemoUserCmd {
...
impl<'a> ::std::default::Default for &'a CDemoSpawnGroups {
    fn default() -> &'a CDemoSpawnGroups {
        <CDemoSpawnGroups as ::steam_vent_proto_common::protobuf::Message>::default_instance()
    }
}
...
impl ::steam_vent_proto_common::protobuf::Message for CDemoSpawnGroups {
...
impl ::steam_vent_proto_common::protobuf::Enum for EDemoCommands {
...
impl ::steam_vent_proto_common::RpcMessage for CDemoFileHeader {
...
impl ::steam_vent_proto_common::RpcMessage for CGameInfo {
    fn parse(reader: &mut dyn std::io::Read) -> ::steam_vent_proto_common::protobuf::Result<Self> {
        <Self as ::steam_vent_proto_common::protobuf::Message>::parse_from_reader(reader)
    }
    fn write(&self, writer: &mut dyn std::io::Write) -> ::steam_vent_proto_common::protobuf::Result<()> {
...
impl ::steam_vent_proto_common::RpcMessage for CDemoFileInfo {
    fn parse(reader: &mut dyn std::io::Read) -> ::steam_vent_proto_common::protobuf::Result<Self> {
        <Self as ::steam_vent_proto_common::protobuf::Message>::parse_from_reader(reader)
    }
    fn write(&self, writer: &mut dyn std::io::Write) -> ::steam_vent_proto_common::protobuf::Result<()> {
...
impl ::steam_vent_proto_common::RpcMessage for CDemoPacket {
    fn parse(reader: &mut dyn std::io::Read) -> ::steam_vent_proto_common::protobuf::Result<Self> {
        <Self as ::steam_vent_proto_common::protobuf::Message>::parse_from_reader(reader)
    }
    fn write(&self, writer: &mut dyn std::io::Write) -> ::steam_vent_proto_common::protobuf::Result<()> {
...
impl ::steam_vent_proto_common::RpcMessage for CDemoFullPacket {
    fn parse(reader: &mut dyn std::io::Read) -> ::steam_vent_proto_common::protobuf::Result<Self> {
        <Self as ::steam_vent_proto_common::protobuf::Message>::parse_from_reader(reader)
    }
    fn write(&self, writer: &mut dyn std::io::Write) -> ::steam_vent_proto_common::protobuf::Result<()> {
...
impl ::steam_vent_proto_common::RpcMessage for CDemoSaveGame {
    fn parse(reader: &mut dyn std::io::Read) -> ::steam_vent_proto_common::protobuf::Result<Self> {
        <Self as ::steam_vent_proto_common::protobuf::Message>::parse_from_reader(reader)
    }
    fn write(&self, writer: &mut dyn std::io::Write) -> ::steam_vent_proto_common::protobuf::Result<()> {
...
impl ::steam_vent_proto_common::RpcMessage for CDemoSyncTick {
    fn parse(reader: &mut dyn std::io::Read) -> ::steam_vent_proto_common::protobuf::Result<Self> {
        <Self as ::steam_vent_proto_common::protobuf::Message>::parse_from_reader(reader)
    }
    fn write(&self, writer: &mut dyn std::io::Write) -> ::steam_vent_proto_common::protobuf::Result<()> {
...
impl ::steam_vent_proto_common::RpcMessage for CDemoConsoleCmd {
    fn parse(reader: &mut dyn std::io::Read) -> ::steam_vent_proto_common::protobuf::Result<Self> {
        <Self as ::steam_vent_proto_common::protobuf::Message>::parse_from_reader(reader)
    }
    fn write(&self, writer: &mut dyn std::io::Write) -> ::steam_vent_proto_common::protobuf::Result<()> {
...
impl ::steam_vent_proto_common::RpcMessage for CDemoSendTables {
    fn parse(reader: &mut dyn std::io::Read) -> ::steam_vent_proto_common::protobuf::Result<Self> {
        <Self as ::steam_vent_proto_common::protobuf::Message>::parse_from_reader(reader)
    }
    fn write(&self, writer: &mut dyn std::io::Write) -> ::steam_vent_proto_common::protobuf::Result<()> {
...
impl ::steam_vent_proto_common::RpcMessage for CDemoClassInfo {
    fn parse(reader: &mut dyn std::io::Read) -> ::steam_vent_proto_common::protobuf::Result<Self> {
        <Self as ::steam_vent_proto_common::protobuf::Message>::parse_from_reader(reader)
    }
    fn write(&self, writer: &mut dyn std::io::Write) -> ::steam_vent_proto_common::protobuf::Result<()> {
...
impl ::steam_vent_proto_common::RpcMessage for CDemoCustomData {
    fn parse(reader: &mut dyn std::io::Read) -> ::steam_vent_proto_common::protobuf::Result<Self> {
        <Self as ::steam_vent_proto_common::protobuf::Message>::parse_from_reader(reader)
    }
    fn write(&self, writer: &mut dyn std::io::Write) -> ::steam_vent_proto_common::protobuf::Result<()> {
...
impl ::steam_vent_proto_common::RpcMessage for CDemoCustomDataCallbacks {
    fn parse(reader: &mut dyn std::io::Read) -> ::steam_vent_proto_common::protobuf::Result<Self> {
        <Self as ::steam_vent_proto_common::protobuf::Message>::parse_from_reader(reader)
    }
    fn write(&self, writer: &mut dyn std::io::Write) -> ::steam_vent_proto_common::protobuf::Result<()> {
...
impl ::steam_vent_proto_common::RpcMessage for CDemoAnimationHeader {
    fn parse(reader: &mut dyn std::io::Read) -> ::steam_vent_proto_common::protobuf::Result<Self> {
        <Self as ::steam_vent_proto_common::protobuf::Message>::parse_from_reader(reader)
    }
    fn write(&self, writer: &mut dyn std::io::Write) -> ::steam_vent_proto_common::protobuf::Result<()> {
...
impl ::steam_vent_proto_common::RpcMessage for CDemoAnimationData {
    fn parse(reader: &mut dyn std::io::Read) -> ::steam_vent_proto_common::protobuf::Result<Self> {
        <Self as ::steam_vent_proto_common::protobuf::Message>::parse_from_reader(reader)
    }
    fn write(&self, writer: &mut dyn std::io::Write) -> ::steam_vent_proto_common::protobuf::Result<()> {
...
impl ::steam_vent_proto_common::RpcMessage for CDemoStringTables {
    fn parse(reader: &mut dyn std::io::Read) -> ::steam_vent_proto_common::protobuf::Result<Self> {
        <Self as ::steam_vent_proto_common::protobuf::Message>::parse_from_reader(reader)
    }
    fn write(&self, writer: &mut dyn std::io::Write) -> ::steam_vent_proto_common::protobuf::Result<()> {
...
impl ::steam_vent_proto_common::RpcMessage for CDemoStop {
    fn parse(reader: &mut dyn std::io::Read) -> ::steam_vent_proto_common::protobuf::Result<Self> {
        <Self as ::steam_vent_proto_common::protobuf::Message>::parse_from_reader(reader)
    }
    fn write(&self, writer: &mut dyn std::io::Write) -> ::steam_vent_proto_common::protobuf::Result<()> {
...
impl ::steam_vent_proto_common::RpcMessage for CDemoUserCmd {
    fn parse(reader: &mut dyn std::io::Read) -> ::steam_vent_proto_common::protobuf::Result<Self> {
        <Self as ::steam_vent_proto_common::protobuf::Message>::parse_from_reader(reader)
    }
    fn write(&self, writer: &mut dyn std::io::Write) -> ::steam_vent_proto_common::protobuf::Result<()> {
...
impl ::steam_vent_proto_common::RpcMessage for CDemoSpawnGroups {
    fn parse(reader: &mut dyn std::io::Read) -> ::steam_vent_proto_common::protobuf::Result<Self> {
        <Self as ::steam_vent_proto_common::protobuf::Message>::parse_from_reader(reader)
    }
    fn write(&self, writer: &mut dyn std::io::Write) -> ::steam_vent_proto_common::protobuf::Result<()> {
