...
impl ::protobuf::Message for PublishedFileDetails_Tag {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_singular_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "display_name",
                |m: &PublishedFileDetails_Tag| { &m.display_name },
                |m: &mut PublishedFileDetails_Tag| { &mut m.display_name },
            ));
...
pub struct CPublishedFile_GetUserFiles_Request {
    ...
    startindex_override: ::std::option::Option<u32>,
    desired_revision: ::std::option::Option<EPublishedFileRevision>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
...
impl CPublishedFile_GetUserFiles_Request {
    ...
    pub fn get_startindex_override(&self) -> u32 {
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                25 => {
                    ...
                    let tmp = is.read_uint32()?;
                    self.startindex_override = ::std::option::Option::Some(tmp);
                },
                33 => {
