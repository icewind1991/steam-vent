...
pub struct CMsgTEExplosion {
    ...
    // @@protoc_insertion_point(field:CMsgTEExplosion.create_debris)
    pub create_debris: ::std::option::Option<bool>,
    // @@protoc_insertion_point(field:CMsgTEExplosion.debris_origin)
    pub debris_origin: ::steam_vent_proto_common::protobuf::MessageField<super::networkbasetypes::CMsgVector>,
    // @@protoc_insertion_point(field:CMsgTEExplosion.debris_surfaceprop)
    pub debris_surfaceprop: ::std::option::Option<u32>,
    // special fields
...
impl CMsgTEExplosion {
    ...
    pub fn create_debris(&self) -> bool {
        self.create_debris.unwrap_or(false)
    }

    pub fn clear_create_debris(&mut self) {
        self.create_debris = ::std::option::Option::None;
    }

    pub fn has_create_debris(&self) -> bool {
        self.create_debris.is_some()
    }

    // Param is passed by value, moved
    pub fn set_create_debris(&mut self, v: bool) {
        self.create_debris = ::std::option::Option::Some(v);
    }

    // optional fixed32 debris_surfaceprop = 14;

    pub fn debris_surfaceprop(&self) -> u32 {
        self.debris_surfaceprop.unwrap_or(0)
    }

    pub fn clear_debris_surfaceprop(&mut self) {
        self.debris_surfaceprop = ::std::option::Option::None;
    }

    pub fn has_debris_surfaceprop(&self) -> bool {
        self.debris_surfaceprop.is_some()
    }

    // Param is passed by value, moved
    pub fn set_debris_surfaceprop(&mut self, v: u32) {
        self.debris_surfaceprop = ::std::option::Option::Some(v);
    }
}
...
impl ::steam_vent_proto_common::protobuf::Message for CMsgTEExplosion {
    ...
    fn merge_from(&mut self, is: &mut ::steam_vent_proto_common::protobuf::CodedInputStream<'_>) -> ::steam_vent_proto_common::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                96 => {
                    self.create_debris = ::std::option::Option::Some(is.read_bool()?);
                },
                106 => {
                    ::steam_vent_proto_common::protobuf::rt::read_singular_message_into_field(is, &mut self.debris_origin)?;
                },
                117 => {
                    self.debris_surfaceprop = ::std::option::Option::Some(is.read_fixed32()?);
                },
                tag => {
                    ::steam_vent_proto_common::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let Some(v) = self.create_debris {
            my_size += 1 + 1;
        }
        if let Some(v) = self.debris_origin.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::steam_vent_proto_common::protobuf::rt::compute_raw_varint64_size(len) + len;
        }
        if let Some(v) = self.debris_surfaceprop {
            my_size += 1 + 4;
        }
        my_size += ::steam_vent_proto_common::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
        self.special_fields.cached_size().set(my_size as u32);
    ...
    fn default_instance() -> &'static CMsgTEExplosion {
        static instance: CMsgTEExplosion = CMsgTEExplosion {
            ...
            create_debris: ::std::option::Option::None,
            debris_origin: ::steam_vent_proto_common::protobuf::MessageField::none(),
            debris_surfaceprop: ::std::option::Option::None,
            special_fields: ::steam_vent_proto_common::protobuf::SpecialFields::new(),
        };
        &instance
    }
