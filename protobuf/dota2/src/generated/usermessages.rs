...
pub mod cuser_msg_particle_manager {
    ...
    pub struct CreateParticle {
        ...
        // @@protoc_insertion_point(field:CUserMsg_ParticleManager.CreateParticle.aggregation_position)
        pub aggregation_position: ::steam_vent_proto_common::protobuf::MessageField<super::super::networkbasetypes::CMsgVector>,
        // special fields
    ...
    impl ::steam_vent_proto_common::protobuf::Message for CreateParticle {
        ...
        fn merge_from(&mut self, is: &mut ::steam_vent_proto_common::protobuf::CodedInputStream<'_>) -> ::steam_vent_proto_common::protobuf::Result<()> {
            while let Some(tag) = is.read_raw_tag_or_eof()? {
                match tag {
                    ...
                    82 => {
                        ::steam_vent_proto_common::protobuf::rt::read_singular_message_into_field(is, &mut self.aggregation_position)?;
                    },
                    tag => {
                        ::steam_vent_proto_common::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                    },
        ...
        fn compute_size(&self) -> u64 {
            ...
            if let Some(v) = self.aggregation_position.as_ref() {
                let len = v.compute_size();
                my_size += 1 + ::steam_vent_proto_common::protobuf::rt::compute_raw_varint64_size(len) + len;
            }
            my_size += ::steam_vent_proto_common::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
        ...
        fn clear(&mut self) {
            ...
            self.cluster = ::std::option::Option::None;
            self.endcap_time = ::std::option::Option::None;
            self.aggregation_position.clear();
            self.special_fields.clear();
        }
        ...
        fn default_instance() -> &'static CreateParticle {
            static instance: CreateParticle = CreateParticle {
                ...
                aggregation_position: ::steam_vent_proto_common::protobuf::MessageField::none(),
                special_fields: ::steam_vent_proto_common::protobuf::SpecialFields::new(),
            };
            &instance
        }
    ...
    pub struct CreatePhysicsSim {
        ...
        // @@protoc_insertion_point(field:CUserMsg_ParticleManager.CreatePhysicsSim.use_high_quality_simulation)
        pub use_high_quality_simulation: ::std::option::Option<bool>,
        // @@protoc_insertion_point(field:CUserMsg_ParticleManager.CreatePhysicsSim.max_particle_count)
        pub max_particle_count: ::std::option::Option<u32>,
        // special fields
    ...
    impl CreatePhysicsSim {
        ...
        pub fn use_high_quality_simulation(&self) -> bool {
            self.use_high_quality_simulation.unwrap_or(false)
        }

        pub fn clear_use_high_quality_simulation(&mut self) {
            self.use_high_quality_simulation = ::std::option::Option::None;
        }

        pub fn has_use_high_quality_simulation(&self) -> bool {
            self.use_high_quality_simulation.is_some()
        }

        // Param is passed by value, moved
        pub fn set_use_high_quality_simulation(&mut self, v: bool) {
            self.use_high_quality_simulation = ::std::option::Option::Some(v);
        }

        // optional uint32 max_particle_count = 3;

        pub fn max_particle_count(&self) -> u32 {
            self.max_particle_count.unwrap_or(0)
        }

        pub fn clear_max_particle_count(&mut self) {
            self.max_particle_count = ::std::option::Option::None;
        }

        pub fn has_max_particle_count(&self) -> bool {
            self.max_particle_count.is_some()
        }

        // Param is passed by value, moved
        pub fn set_max_particle_count(&mut self, v: u32) {
            self.max_particle_count = ::std::option::Option::Some(v);
        }
    }
    ...
    impl ::steam_vent_proto_common::protobuf::Message for CreatePhysicsSim {
        ...
        fn merge_from(&mut self, is: &mut ::steam_vent_proto_common::protobuf::CodedInputStream<'_>) -> ::steam_vent_proto_common::protobuf::Result<()> {
            while let Some(tag) = is.read_raw_tag_or_eof()? {
                match tag {
                    ...
                    16 => {
                        self.use_high_quality_simulation = ::std::option::Option::Some(is.read_bool()?);
                    },
                    24 => {
                        self.max_particle_count = ::std::option::Option::Some(is.read_uint32()?);
                    },
                    tag => {
                        ::steam_vent_proto_common::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                    },
        ...
        fn compute_size(&self) -> u64 {
            ...
            if let Some(v) = self.use_high_quality_simulation {
                my_size += 1 + 1;
            }
            if let Some(v) = self.max_particle_count {
                my_size += ::steam_vent_proto_common::protobuf::rt::uint32_size(3, v);
            }
            my_size += ::steam_vent_proto_common::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
            self.special_fields.cached_size().set(my_size as u32);
        ...
        fn default_instance() -> &'static CreatePhysicsSim {
            static instance: CreatePhysicsSim = CreatePhysicsSim {
                ...
                use_high_quality_simulation: ::std::option::Option::None,
                max_particle_count: ::std::option::Option::None,
                special_fields: ::steam_vent_proto_common::protobuf::SpecialFields::new(),
            };
            &instance
        }
...
pub struct CUserMessage_NotifyResponseFound {
    ...
    // @@protoc_insertion_point(field:CUserMessage_NotifyResponseFound.int_criteria_names)
    pub int_criteria_names: ::std::vec::Vec<u32>,
    // @@protoc_insertion_point(field:CUserMessage_NotifyResponseFound.int_criteria_values)
    pub int_criteria_values: ::std::vec::Vec<i32>,
    // @@protoc_insertion_point(field:CUserMessage_NotifyResponseFound.float_criteria_names)
    pub float_criteria_names: ::std::vec::Vec<u32>,
    // @@protoc_insertion_point(field:CUserMessage_NotifyResponseFound.float_criteria_values)
    pub float_criteria_values: ::std::vec::Vec<f32>,
    // @@protoc_insertion_point(field:CUserMessage_NotifyResponseFound.symbol_criteria_names)
    pub symbol_criteria_names: ::std::vec::Vec<u32>,
    // @@protoc_insertion_point(field:CUserMessage_NotifyResponseFound.symbol_criteria_values)
    pub symbol_criteria_values: ::std::vec::Vec<u32>,
    // special fields
...
impl ::steam_vent_proto_common::protobuf::Message for CUserMessage_NotifyResponseFound {
    ...
    fn merge_from(&mut self, is: &mut ::steam_vent_proto_common::protobuf::CodedInputStream<'_>) -> ::steam_vent_proto_common::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                50 => {
                    is.read_repeated_packed_uint32_into(&mut self.int_criteria_names)?;
                },
                48 => {
                    self.int_criteria_names.push(is.read_uint32()?);
                },
                58 => {
                    is.read_repeated_packed_int32_into(&mut self.int_criteria_values)?;
                },
                56 => {
                    self.int_criteria_values.push(is.read_int32()?);
                },
                66 => {
                    is.read_repeated_packed_uint32_into(&mut self.float_criteria_names)?;
                },
                64 => {
                    self.float_criteria_names.push(is.read_uint32()?);
                },
                74 => {
                    is.read_repeated_packed_float_into(&mut self.float_criteria_values)?;
                },
                77 => {
                    self.float_criteria_values.push(is.read_float()?);
                },
                82 => {
                    is.read_repeated_packed_uint32_into(&mut self.symbol_criteria_names)?;
                },
                80 => {
                    self.symbol_criteria_names.push(is.read_uint32()?);
                },
                90 => {
                    is.read_repeated_packed_uint32_into(&mut self.symbol_criteria_values)?;
                },
                88 => {
                    self.symbol_criteria_values.push(is.read_uint32()?);
                },
                tag => {
                    ::steam_vent_proto_common::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::steam_vent_proto_common::protobuf::rt::vec_packed_uint32_size(6, &self.int_criteria_names);
        my_size += ::steam_vent_proto_common::protobuf::rt::vec_packed_int32_size(7, &self.int_criteria_values);
        my_size += ::steam_vent_proto_common::protobuf::rt::vec_packed_uint32_size(8, &self.float_criteria_names);
        my_size += 5 * self.float_criteria_values.len() as u64;
        my_size += ::steam_vent_proto_common::protobuf::rt::vec_packed_uint32_size(10, &self.symbol_criteria_names);
        my_size += ::steam_vent_proto_common::protobuf::rt::vec_packed_uint32_size(11, &self.symbol_criteria_values);
        my_size += ::steam_vent_proto_common::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
        self.special_fields.cached_size().set(my_size as u32);
        my_size
    }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::steam_vent_proto_common::protobuf::CodedOutputStream<'_>) -> ::steam_vent_proto_common::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(6, &self.int_criteria_names)?;
        os.write_repeated_packed_int32(7, &self.int_criteria_values)?;
        os.write_repeated_packed_uint32(8, &self.float_criteria_names)?;
        for v in &self.float_criteria_values {
            os.write_float(9, *v)?;
        };
        os.write_repeated_packed_uint32(10, &self.symbol_criteria_names)?;
        os.write_repeated_packed_uint32(11, &self.symbol_criteria_values)?;
        os.write_unknown_fields(self.special_fields.unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn clear(&mut self) {
        ...
        self.response_concept = ::std::option::Option::None;
        self.criteria.clear();
        self.int_criteria_names.clear();
        self.int_criteria_values.clear();
        self.float_criteria_names.clear();
        self.float_criteria_values.clear();
        self.symbol_criteria_names.clear();
        self.symbol_criteria_values.clear();
        self.special_fields.clear();
    }
    ...
    fn default_instance() -> &'static CUserMessage_NotifyResponseFound {
        static instance: CUserMessage_NotifyResponseFound = CUserMessage_NotifyResponseFound {
            ...
            int_criteria_names: ::std::vec::Vec::new(),
            int_criteria_values: ::std::vec::Vec::new(),
            float_criteria_names: ::std::vec::Vec::new(),
            float_criteria_values: ::std::vec::Vec::new(),
            symbol_criteria_names: ::std::vec::Vec::new(),
            symbol_criteria_values: ::std::vec::Vec::new(),
            special_fields: ::steam_vent_proto_common::protobuf::SpecialFields::new(),
        };
        &instance
    }
...
pub struct CUserMessage_PlayResponseConditional {
    ...
    // @@protoc_insertion_point(field:CUserMessage_PlayResponseConditional.pre_delay)
    pub pre_delay: ::std::option::Option<f32>,
    // special fields
...
impl CUserMessage_PlayResponseConditional {
    ...
    pub fn pre_delay(&self) -> f32 {
        self.pre_delay.unwrap_or(0.)
    }

    pub fn clear_pre_delay(&mut self) {
        self.pre_delay = ::std::option::Option::None;
    }

    pub fn has_pre_delay(&self) -> bool {
        self.pre_delay.is_some()
    }

    // Param is passed by value, moved
    pub fn set_pre_delay(&mut self, v: f32) {
        self.pre_delay = ::std::option::Option::Some(v);
    }
}
...
impl ::steam_vent_proto_common::protobuf::Message for CUserMessage_PlayResponseConditional {
    ...
    fn merge_from(&mut self, is: &mut ::steam_vent_proto_common::protobuf::CodedInputStream<'_>) -> ::steam_vent_proto_common::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                45 => {
                    self.pre_delay = ::std::option::Option::Some(is.read_float()?);
                },
                tag => {
                    ::steam_vent_proto_common::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn default_instance() -> &'static CUserMessage_PlayResponseConditional {
        static instance: CUserMessage_PlayResponseConditional = CUserMessage_PlayResponseConditional {
            ...
            pre_delay: ::std::option::Option::None,
            special_fields: ::steam_vent_proto_common::protobuf::SpecialFields::new(),
        };
        &instance
    }
