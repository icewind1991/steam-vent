...
service_method!("Authentication.BeginAuthSessionViaCredentials" => steam_vent_proto::steammessages_auth_steamclient::CAuthentication_BeginAuthSessionViaCredentials_Request, steam_vent_proto::steammessages_auth_steamclient::CAuthentication_BeginAuthSessionViaCredentials_Response);
service_method!("Authentication.UpdateAuthSessionWithSteamGuardCode" => steam_vent_proto::steammessages_auth_steamclient::CAuthentication_UpdateAuthSessionWithSteamGuardCode_Request, steam_vent_proto::steammessages_auth_steamclient::CAuthentication_UpdateAuthSessionWithSteamGuardCode_Response);
service_method!("Authentication.PollAuthSessionStatus" => steam_vent_proto::steammessages_auth_steamclient::CAuthentication_PollAuthSessionStatus_Request, steam_vent_proto::steammessages_auth_steamclient::CAuthentication_PollAuthSessionStatus_Response);
